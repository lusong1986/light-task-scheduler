...
public class SQLFormatter {
	...
	static {
		...
		UPPER_CASE.addAll(Arrays.asList("select", "insert", "update", "delete", "on", "left", "right", "inner",
				"outer", "group", "order", "where", "set", "having", "join", "from", "by", "join", "into", "union",
				"and", "or", "when", "else", "end", "in", "all", "exists", "if", "some", "any", "distinct", "count",
				"sum", "as", "asc", "desc", "between", "alter", "table", "else", "elseif", "index", "ignore", "limit",
				"like", "offset"));

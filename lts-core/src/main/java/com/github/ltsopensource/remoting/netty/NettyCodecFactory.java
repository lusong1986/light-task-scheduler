...
public class NettyCodecFactory {
	...
	public class NettyEncoder extends MessageToByteEncoder<RemotingCommand> {
		...
		public void encode(ChannelHandlerContext ctx, RemotingCommand remotingCommand, ByteBuf out) throws Exception {
			...
			try {
				...
				LOGGER.error("encode exception, addr={}, remotingCommand={}",
						RemotingHelper.parseChannelRemoteAddr(channel), remotingCommand.toString(), e);
	...
	public class NettyDecoder extends LengthFieldBasedFrameDecoder {
		...
		public NettyDecoder() {
			super(appContext.getConfig().getParameter(ExtConfig.NETTY_FRAME_LENGTH_MAX, Constants.DEFAULT_BUFFER_SIZE),
					0, 4, 0, 4);
		}

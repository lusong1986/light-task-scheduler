...
public class HttpCmdAcceptor {
	...
	public HttpCmdAcceptor(ServerSocket serverSocket, HttpCmdContext context) {
		...
		this.executorService = new ThreadPoolExecutor(Constants.AVAILABLE_PROCESSOR, Constants.AVAILABLE_PROCESSOR, 0L,
				TimeUnit.MILLISECONDS, new LinkedBlockingQueue<Runnable>(100), new ThreadPoolExecutor.DiscardPolicy());
	}

...
/**
 * @author Robert HG (254963746@qq.com) on 7/24/14. 处理 TaskTracker的 Job pull 请求
 */
public class JobPullProcessor extends AbstractRemotingProcessor {
	...
	@Override
	public RemotingCommand processRequest(final Channel ctx, final RemotingCommand request)
		...
		if (LOGGER.isDebugEnabled()) {
			LOGGER.debug("taskTrackerNodeGroup:{}, taskTrackerIdentity:{} , availableThreads:{}",
					requestBody.getNodeGroup(), requestBody.getIdentity(), requestBody.getAvailableThreads());
		}

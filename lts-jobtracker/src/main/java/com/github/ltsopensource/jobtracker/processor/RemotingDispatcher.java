...
import com.github.ltsopensource.core.protocol.JobProtos.RequestCode;
...
/**
 * @author Robert HG (254963746@qq.com) on 7/23/14. job tracker 总的处理器, 每一种命令对应不同的处理器
 */
public class RemotingDispatcher extends AbstractRemotingProcessor {
	...
	public RemotingDispatcher(JobTrackerAppContext appContext) {
		...
		this.reqLimitAcquireTimeout = appContext.getConfig().getParameter(
				ExtConfig.JOB_TRACKER_REMOTING_REQ_LIMIT_ACQUIRE_TIMEOUT, 50);
	}

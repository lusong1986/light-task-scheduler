...
public class StopWorkingMonitor {
	...
	private final ScheduledExecutorService SCHEDULED_CHECKER = Executors.newScheduledThreadPool(1,
			new NamedThreadFactory("LTS-StopWorking-Monitor", true));
					...
					public void run() {
						try {
							...
							if (offlineTimestamp != null
								...
								CatUtils.recordEvent(false, "TASK_TRACKER_FORCE_OFFLINE", "STOP_WORKING_MONITOR");
								// 停止所有任务，生成新的线程池，jobtracker连上后可以继续执行job
